...
public class Piece : MonoBehaviour
{
    ...
    public void PlaceOn(Slot slot , bool UpdatePiece)
    ...
    public void OnSuccessfulMove(Slot to, MoveActionTypes action, int stepPlayed)
    {
        ...
        if ((action & MoveActionTypes.Hit) == MoveActionTypes.Hit)
        {
            ...
            enemyPiece.PlaceOn(enemyBar.GetComponent<Slot>(), false);
        }
    ...
    private void OnReciveMove(Piece piece, Slot to, MoveActionTypes action, int stepPlayed)
    {
        ...
        if ((action & MoveActionTypes.Hit) == MoveActionTypes.Hit)
        {
            ...
            lastMove.piece.PlaceOn(enemyBar.GetComponent<Slot>(), false);
        }
        ...
        // place on new slot
         ...
         lastMove.piece.PlaceOn(lastMove.to, false);
